...
//	
	...
	public static void getImage() {
		renderBinary(new File("public/images/2m.jpg"));
	}

	public static void getBigFile() {
		renderBinary(new File("public/xmind-8-beta-macosx.dmg"));
	}
	...
	public static void nginxUpload(NginxUpload attachment, String comment){
		File f = new File(attachment.path);
		f.delete();
		renderText("\n" + comment + ":" + attachment.toString());
	}
}
