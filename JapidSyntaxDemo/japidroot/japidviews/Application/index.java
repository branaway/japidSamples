...
"	<li><a href=\"");// line 104, index.html
		p(lookupStatic("/public/images/2m.jpg"));// line 105, index.html
		p("\">a 2MB image file</a></li>\n" + 
"	<li><a href=\"");// line 105, index.html
		p(lookupStatic("/public/xmind-8-beta-macosx.dmg"));// line 106, index.html
		p("\">a big binary file</a></li>\n" + 
"	\n" + 
"</ul>\n" + 
"\n");// line 106, index.html
		logDuration("dd");// line 110, index.html
		p("<p>Reverse lookup is really slow...</p>\n" + 
"\n" + 
"<p>app mode: \"");// line 110, index.html
		p(_play.mode);// line 113, index.html
		p("\"</p>\n" + 
"\n" + 
"<br/>\n");// line 113, index.html
